<%@ Page Title="" Language="C#" MasterPageFile="~/web/webmaster.master" AutoEventWireup="true" CodeFile="newproductlist.aspx.cs" Inherits="newproductlist" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="row">
      ...
      <tr>
        ...
        <div class="col-md-10">
            <div style="height:41px;background-image:url(images/body/xian.jpg)"><h3 style="color:white">新品上架</h3></div>
        ...
        <ItemTemplate>
            ...
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="getnewproductlist" TypeName="product"></asp:ObjectDataSource>
