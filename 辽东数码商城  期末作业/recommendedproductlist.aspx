<%@ Page Title="" Language="C#" MasterPageFile="~/web/webmaster.master" AutoEventWireup="true" CodeFile="recommendedproductlist.aspx.cs" Inherits="recommendedproductlist" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="row">
      ...
      <tr>
        ...
        <div class="col-md-10" >
            <div style="height:41px;background-image:url(images/body/xian.jpg);"><h3 style="color:white">热销推荐</h3></div>
        ...
        <ItemTemplate>
            ...
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="getrecommendedproduct" TypeName="product"></asp:ObjectDataSource>
