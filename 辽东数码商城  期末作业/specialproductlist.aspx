<%@ Page Title="" Language="C#" MasterPageFile="~/web/webmaster.master" AutoEventWireup="true" CodeFile="specialproductlist.aspx.cs" Inherits="specialproductlist" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="row">
      ...
      <tr>
        ...
        <div class="col-md-10">
            <div style="height:41px;background-image:url(images/body/xian.jpg)"><h3 style="color:white">特价商品</h3></div>
        ...
        <ItemTemplate>
            ...
            <table style="width:95%;border:0"  >
              <tr>
                ...
                <td style="width:22%">
                    ...
                    <tr>
                      <td style="height:25px">会员价：<s><%#Eval("userprice") %></s>元 </td>
                    </tr>
                        <tr>
                      <td style="height:25px">特价：<%#Eval("specialsprice") %>元 </td>
                    </tr>
                  </table></td>
            ...
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="getspecialproduct" TypeName="product"></asp:ObjectDataSource>
